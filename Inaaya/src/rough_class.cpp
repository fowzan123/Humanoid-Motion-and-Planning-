...
class state_publisher{
    ...
    private:
            ...
            void callback(const chapter5_tutorials::odom_arduino::ConstPtr& ticks);
};
state_publisher::state_publisher()
{
    odom_pub=n.advertise<nav_msgs::Odometry>("odom", 10);
    arduino_subscriber=n.subscribe("odom_data", 10, &state_publisher::callback, this);
...
void state_publisher::callback(const chapter5_tutorials::odom_arduino::ConstPtr& ticks)
{
    	            double V,W,theta;
                current_time_encoder = ros::Time::now();
